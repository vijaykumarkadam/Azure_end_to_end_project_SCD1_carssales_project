# car_sales_asset_bundle

The 'car_sales_asset_bundle' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/car_sales_asset_bundle/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] car_sales_asset_bundle_etl` to your workspace.
